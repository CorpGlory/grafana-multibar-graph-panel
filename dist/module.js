...
var GraphRenderer = /** @class */ (function () {
    ...
    GraphRenderer.prototype._displaySideBySide = function (sortedSeries, options) {
        var barsSeries = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.filter(sortedSeries, function (series) { return series.bars && series.bars.show !== false; });
    ...
    GraphRenderer.prototype._addTimeAxis = function () {
        ...
        var min = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.isUndefined(this.ctrl.range.from) ? null : this.ctrl.range.from.valueOf();
        var max = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.isUndefined(this.ctrl.range.to) ? null : this.ctrl.range.to.valueOf();
...
var GraphCtrl = /** @class */ (function (_super) {
    ...
    GraphCtrl.prototype.link = function (scope, elem, attrs, ctrl) {
        ...
        this._graphRenderer = new _graph_renderer__WEBPACK_IMPORTED_MODULE_0__["GraphRenderer"]($graphElem, this.timeSrv, this.popoverSrv, this.contextSrv, this.$scope);
