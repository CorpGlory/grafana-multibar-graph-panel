...
var GraphLegend = /** @class */ (function () {
    ...
    GraphLegend.prototype.render = function () {
        ...
        if (this.panel.legend.sort) {
            this.seriesList = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.sortBy(this.seriesList, function (series) {
...
var GraphRenderer = /** @class */ (function () {
    ...
    GraphRenderer.prototype._addTimeAxis = function (minTimeStep) {
        ...
        if (this.panel.bars && this.sortedSeries.length > 0 && this.sortedSeries[0].datapoints.length > 0) {
            ...
            if (generatedTicks.length !== 0) {
                ...
                var format_1 = this._timeFormat(generatedTicks, min, max);
                ...
                ticks = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(generatedTicks, function (tick) {
                    ...
                    var utcDate = new Date(date.getTime() + date.getTimezoneOffset() * secondsInMinute * msInSecond);
                    return [
                        tick[0],
                        formatDate_1(utcDate, format_1)
                    ];
                });
            }
        }
    ...
    GraphRenderer.prototype._generateTicks = function (groupsAmount, maxTicks, rangeFrom, rangeTo, timeStep) {
        ...
        var seriesInRange = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(this.sortedSeries, function (serie) {
            return serie.datapoints.filter(function (datapoint) { return datapoint[1] >= rangeFrom && datapoint[1] <= rangeTo; });
        });
