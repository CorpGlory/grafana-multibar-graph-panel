define(["lodash","jquery","angular","app/core/utils/kbn","moment","app/core/core","app/core/core_module","app/core/config","app/plugins/sdk"], function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_35__, __WEBPACK_EXTERNAL_MODULE_36__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor_flot_jquery_flot__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vendor_flot_jquery_flot_orderbars__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vendor_flot_jquery_flot_orderbars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__vendor_flot_jquery_flot_orderbars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vendor_flot_jquery_flot_stack__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vendor_flot_jquery_flot_stack___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__vendor_flot_jquery_flot_stack__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__vendor_flot_jquery_flot_stackpercent__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__vendor_flot_jquery_flot_stackpercent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__vendor_flot_jquery_flot_stackpercent__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__vendor_flot_jquery_flot_fillbelow__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__vendor_flot_jquery_flot_fillbelow___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__vendor_flot_jquery_flot_fillbelow__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__vendor_flot_jquery_flot_crosshair__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__vendor_flot_jquery_flot_crosshair___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__vendor_flot_jquery_flot_crosshair__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__vendor_flot_jquery_flot_dashes__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__vendor_flot_jquery_flot_dashes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__vendor_flot_jquery_flot_dashes__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__vendor_grafana_event_manager__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__vendor_grafana_time_series2__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__vendor_grafana_ticks__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_jquery__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_lodash__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_moment__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_grafana_app_core_utils_kbn__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_grafana_app_core_utils_kbn___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16_grafana_app_core_utils_kbn__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_grafana_app_core_core__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_grafana_app_core_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17_grafana_app_core_core__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__graph_tooltip__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__graph_tooltip___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_18__graph_tooltip__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__threshold_manager__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__histogram__ = __webpack_require__(28);
...
function graphDirective(timeSrv, popoverSrv, contextSrv) {
    return {
        ...
        link: function (scope, elem) {
            ...
            var sortedSeries;
            var panelWidth = 0;
            var eventManager = new __WEBPACK_IMPORTED_MODULE_10__vendor_grafana_event_manager__["a" /* EventManager */](ctrl);
            var thresholdManager = new __WEBPACK_IMPORTED_MODULE_19__threshold_manager__["a" /* ThresholdManager */](ctrl);
            var tooltip = new __WEBPACK_IMPORTED_MODULE_18__graph_tooltip___default.a(elem, dashboard, scope, function () {
                return sortedSeries;
            });
            // panel events
            ...
            ctrl.events.on('render', function (renderData) {
                ...
                buildFlotPairs(data);
                Object(__WEBPACK_IMPORTED_MODULE_11__vendor_grafana_time_series2__["c" /* updateLegendValues */])(data, panel);
            ...
            // global events
            __WEBPACK_IMPORTED_MODULE_17_grafana_app_core_core__["appEvents"].on('graph-hover', function (evt) {
            ...
            __WEBPACK_IMPORTED_MODULE_17_grafana_app_core_core__["appEvents"].on('graph-hover-clear', function (event, info) {
                if (plot) {
                    tooltip.clear(plot);
                }
            }, scope);
            ...
            function drawHook(plot) {
                ...
                if (panel.yaxes[0].label && panel.yaxes[0].show) {
                    __WEBPACK_IMPORTED_MODULE_13_jquery__("<div class='axisLabel left-yaxis-label flot-temp-elem'></div>")
                        .text(panel.yaxes[0].label)
                        .appendTo(elem);
                }
                // add right axis labels
                if (panel.yaxes[1].label && panel.yaxes[1].show) {
                    __WEBPACK_IMPORTED_MODULE_13_jquery__("<div class='axisLabel right-yaxis-label flot-temp-elem'></div>")
                        .text(panel.yaxes[1].label)
                        .appendTo(elem);
                }
                if (ctrl.dataWarning) {
                    __WEBPACK_IMPORTED_MODULE_13_jquery__("<div class=\"datapoints-warning flot-temp-elem\">" + ctrl.dataWarning.title + "</div>").appendTo(elem);
                }
            ...
            function prepareXAxis(options, panel) {
                switch (panel.xaxis.mode) {
                    ...
                    case 'histogram': {
                        ...
                        var values = Object(__WEBPACK_IMPORTED_MODULE_20__histogram__["b" /* getSeriesValues */])(data);
                        if (data.length && values.length) {
                            var histMin = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.min(__WEBPACK_IMPORTED_MODULE_14_lodash___default.a.map(data, function (s) { return s.stats.min; }));
                            var histMax = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.max(__WEBPACK_IMPORTED_MODULE_14_lodash___default.a.map(data, function (s) { return s.stats.max; }));
                            var ticks = panel.xaxis.buckets || panelWidth / 50;
                            bucketSize = Object(__WEBPACK_IMPORTED_MODULE_12__vendor_grafana_ticks__["b" /* tickStep */])(histMin, histMax, ticks);
                            var histogram = Object(__WEBPACK_IMPORTED_MODULE_20__histogram__["a" /* convertValuesToHistogram */])(values, bucketSize);
            ...
            function displaySideBySide(sortedSeries, options) {
                var barsSeries = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.filter(sortedSeries, function (series) { return series.bars && series.bars.show !== false; });
            ...
            function callPlot(options, incrementRenderCounter) {
                try {
                    plot = __WEBPACK_IMPORTED_MODULE_13_jquery__["plot"](elem, sortedSeries, options);
                    if (ctrl.renderError) {
                        delete ctrl.error;
            ...
            function addTimeAxis(options) {
                ...
                var min = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.isUndefined(ctrl.range.from) ? null : ctrl.range.from.valueOf();
                var max = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.isUndefined(ctrl.range.to) ? null : ctrl.range.to.valueOf();
                options.xaxis = {
            ...
            function addXSeriesAxis(options) {
                var ticks = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.map(data, function (series, index) {
            ...
            function addXHistogramAxis(options, bucketSize) {
                ...
                if (data.length && bucketSize) {
                    ticks = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.map(data[0].data, function (point) { return point[0]; });
                    min = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.min(ticks);
                    max = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.max(ticks);
                    // Adjust tick step
            ...
            function addXTableAxis(options) {
                var ticks = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.map(data, function (series, seriesIndex) {
                    return __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.map(series.datapoints, function (point, pointIndex) {
                        var tickIndex = seriesIndex * series.datapoints.length + pointIndex;
                        return [tickIndex + 1, point[1]];
                    });
                });
                ticks = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.flatten(ticks, true);
                options.xaxis = {
                    timezone: dashboard.getTimezone(),
                    show: panel.xaxis.show,
                    mode: null,
            ...
            function configureYAxisOptions(data, options) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_14_lodash___default.a.find(data, { yaxis: 2 })) {
                    var secondY = __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.clone(defaults);
                    secondY.index = 2;
            ...
            function parseNumber(value) {
                ...
                return __WEBPACK_IMPORTED_MODULE_14_lodash___default.a.toNumber(value);
            }
            ...
            function configureAxisMode(axis, format) {
                axis.tickFormatter = function (val, axis) {
                    return __WEBPACK_IMPORTED_MODULE_16_grafana_app_core_utils_kbn___default.a.valueFormats[format](val, axis.tickDecimals, axis.scaledDecimals);
                };
            }
            ...
            elem.bind('plotselected', function (event, ranges) {
                ...
                if ((ranges.ctrlKey || ranges.metaKey) && contextSrv.isEditor) {
                    ...
                    scope.$apply(function () {
                        timeSrv.setTime({
                            from: __WEBPACK_IMPORTED_MODULE_15_moment___default.a.utc(ranges.xaxis.from),
                            to: __WEBPACK_IMPORTED_MODULE_15_moment___default.a.utc(ranges.xaxis.to),
                        });
                    });
                }
            });
...
__WEBPACK_IMPORTED_MODULE_17_grafana_app_core_core__["coreModule"].directive('grafanaGraph', graphDirective);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event__ = __webpack_require__(25);
...
__WEBPACK_IMPORTED_MODULE_0_grafana_app_core_core_module___default.a.directive('multibarGraphPanelThresholdForm', function () {
    return {
        restrict: 'E',
        template: template,
