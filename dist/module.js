...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _graph_tooltip__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graph_tooltip */ "./graph_tooltip.js");
/* harmony import */ var _graph_tooltip__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_graph_tooltip__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! grafana/app/core/utils/kbn */ "grafana/app/core/utils/kbn");
/* harmony import */ var grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var grafana_app_core_core__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! grafana/app/core/core */ "grafana/app/core/core");
/* harmony import */ var grafana_app_core_core__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(grafana_app_core_core__WEBPACK_IMPORTED_MODULE_18__);
...
function graphDirective(timeSrv, popoverSrv, contextSrv) {
    return {
        ...
        link: function (scope, elem) {
            ...
            var sortedSeries;
            var panelWidth = 0;
            var eventManager = new _vendor_grafana_event_manager__WEBPACK_IMPORTED_MODULE_14__["EventManager"](ctrl);
            var thresholdManager = new _threshold_manager__WEBPACK_IMPORTED_MODULE_1__["ThresholdManager"](ctrl);
            var tooltip = new _graph_tooltip__WEBPACK_IMPORTED_MODULE_0___default.a(elem, dashboard, scope, function () {
                return sortedSeries;
            });
            // panel events
            ...
            ctrl.events.on('render', function (renderData) {
                ...
                buildFlotPairs(data);
                Object(_vendor_grafana_time_series2__WEBPACK_IMPORTED_MODULE_15__["updateLegendValues"])(data, panel);
            ...
            // global events
            grafana_app_core_core__WEBPACK_IMPORTED_MODULE_18__["appEvents"].on('graph-hover', function (evt) {
            ...
            grafana_app_core_core__WEBPACK_IMPORTED_MODULE_18__["appEvents"].on('graph-hover-clear', function (event, info) {
                if (plot) {
                    tooltip.clear(plot);
                }
            }, scope);
            ...
            function drawHook(plot) {
                ...
                if (ctrl.dataWarning) {
                    jquery__WEBPACK_IMPORTED_MODULE_3___default()("<div class=\"datapoints-warning flot-temp-elem\">" + ctrl.dataWarning.title + "</div>").appendTo(elem);
                }
                ...
                switch (panel.xaxis.mode) {
                    ...
                    case 'histogram': {
                        ...
                        if (data.length && values.length) {
                            var histMin = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.min(lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(data, function (s) { return s.stats.min; }));
                            var histMax = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.max(lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(data, function (s) { return s.stats.max; }));
            ...
            function callPlot(options, incrementRenderCounter) {
                try {
                    plot = jquery__WEBPACK_IMPORTED_MODULE_3___default.a.plot(elem, sortedSeries, options);
                    if (ctrl.renderError) {
                        delete ctrl.error;
            ...
            function addTimeAxis(options) {
                ...
                var min = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.isUndefined(ctrl.range.from) ? null : ctrl.range.from.valueOf();
                var max = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.isUndefined(ctrl.range.to) ? null : ctrl.range.to.valueOf();
                options.xaxis = {
            ...
            function addXSeriesAxis(options) {
                var ticks = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(data, function (series, index) {
            ...
            function addXHistogramAxis(options, bucketSize) {
                ...
                if (data.length && bucketSize) {
                    ticks = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(data[0].data, function (point) { return point[0]; });
            ...
            function addXTableAxis(options) {
                var ticks = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(data, function (series, seriesIndex) {
                    return lodash__WEBPACK_IMPORTED_MODULE_19___default.a.map(series.datapoints, function (point, pointIndex) {
                        var tickIndex = seriesIndex * series.datapoints.length + pointIndex;
                        return [tickIndex + 1, point[1]];
                    });
                });
                ticks = lodash__WEBPACK_IMPORTED_MODULE_19___default.a.flatten(ticks, true);
                options.xaxis = {
                    timezone: dashboard.getTimezone(),
                    show: panel.xaxis.show,
                    mode: null,
            ...
            function configureAxisMode(axis, format) {
                axis.tickFormatter = function (val, axis) {
                    return grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_17___default.a.valueFormats[format](val, axis.tickDecimals, axis.scaledDecimals);
                };
            }
            ...
            elem.bind('plotselected', function (event, ranges) {
                ...
                if ((ranges.ctrlKey || ranges.metaKey) && contextSrv.isEditor) {
                    ...
                    scope.$apply(function () {
                        timeSrv.setTime({
                            from: moment__WEBPACK_IMPORTED_MODULE_20___default.a.utc(ranges.xaxis.from),
                            to: moment__WEBPACK_IMPORTED_MODULE_20___default.a.utc(ranges.xaxis.to),
                        });
                    });
                }
            });
...
grafana_app_core_core__WEBPACK_IMPORTED_MODULE_18__["coreModule"].directive('grafanaGraph', graphDirective);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
  ...
  __webpack_require__(/*! grafana/app/core/core */ "grafana/app/core/core"),
